...
private fun enumPropertyType(property: ComponentProperties, componentName: String): TypeName {
...
private fun objectPropertyType(property: ComponentProperties, components: List<Component>): TypeName {
...
private fun arrayPropertyType(property: ComponentProperties, components: List<Component>): TypeName {
...
private fun simplePropertyType(property: ComponentProperties): TypeName {
