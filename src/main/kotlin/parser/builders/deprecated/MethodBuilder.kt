...
//}
//
//private fun getMethod(path: Path, method: HttpMethods): Method {
...
//}
//
//private fun getParameters(parameters: List<Parameter>?): List<datamodel.deprecated.Parameter> {
//    if (parameters.isNullOrEmpty()) return emptyList()
//
//    return parameters.map {
//        datamodel.deprecated.Parameter(
//            name = it.name,
